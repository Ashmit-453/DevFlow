          ...
          <div className="flex flex-col gap-3">
            ...
            <SheetClose asChild>
              <Link href={ROUTES.SIGN_UP}>
                <Button className="small-medium light-border-2 btn-tertiary text-dark400_light900 min-h-[41px] w-full rounded-lg border px-4 py-1 shadow-none cursor-pointer">
                  Sign Up
                </Button>
              </Link>
            </SheetClose>
